# Registre des Impacts et Soumissions

## Soumissions Académiques

### 15 Septembre 2026 - Experimental Mathematics (Taylor & Francis)
- **Titre** : Weighing the obstruction: the smoothness of p-1, its parity signature, and a measured Tamagawa reconstruction of the twin-prime constant
- **Auteur** : Fouad Bensmail
- **Statut** : SOUMIS (En attente du check éditorial)
